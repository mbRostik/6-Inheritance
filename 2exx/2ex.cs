...
internal class Program
{
    ...
    static void Main()
    {
        try
        {
            ...
            Console.WriteLine();
            Console.WriteLine(book.Author+" "+book.Title+" "+ Math.Round(book.Price, 2) + "\n");
            Console.WriteLine("Gold Edition: "+goldenEditionBook.Author + " " + goldenEditionBook.Title + " " + Math.Round(goldenEditionBook.Price, 2) + "\n");
        }
